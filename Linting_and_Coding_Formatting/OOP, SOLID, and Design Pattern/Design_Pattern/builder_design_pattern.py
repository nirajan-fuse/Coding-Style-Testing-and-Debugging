# [Builder Design Pattern] Design a document generator using the Builder Design Pattern. Create a
# DocumentBuilder that creates documents of various types (e.g., PDF, HTML, Plain Text). Implement
# the builder methods to format the document content and structure according to the chosen type.
# Demonstrate how the Builder Design Pattern allows for the creation of different document formats
# without tightly coupling the document generation logic.
...
def main():
    ...
    document_director.build_document(
        "Plain Text", "Plain Text Subject", "Plain Text Document"
    )
